            ...
            <table id="sorting-table" class="table">
                ...
                <tbody id="product-list">
                    <tr>
                        ...
                        <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                data-toggle="modal" data-target="#exampleModal2" id="addRestock0">Restock</a></td>
                        <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                data-toggle="modal" data-target="#exampleModal3" id="addReduce0">Reduce Stock</a></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                data-toggle="modal" data-target="#exampleModal2" id="addRestock1">Restock</a></td>
                        <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                data-toggle="modal" data-target="#exampleModal3" id="addReduce1">Reduce Stock</a></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                data-toggle="modal" data-target="#exampleModal2" id="addRestock2">Restock</a></td>
                        <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                data-toggle="modal" data-target="#exampleModal3" id="addReduce2">Reduce Stock</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                data-toggle="modal" data-target="#exampleModal2" id="addRestock3">Restock</a></td>
                        <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                data-toggle="modal" data-target="#exampleModal3" id="addReduce3">Reduce Stock</a>
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <div class="all-content">
                        <div class="modal-header">
                            ...
                            <button type="button" data-dismiss="modal" aria-label="Close"
                                class="close cl-btn"><span aria-hidden="true">×</span></button>
                        </div>
                        <div id="inventory-modal-box" class="inventory-modal">
                            <div class="modal-body form-group box-content-sector">
                                ...
                                <div class="item-section">
                                    ...
                                    <input type="number" name="quantity" id="quatity" min="1"
                                        pattern="\d+" required="required" class="form-control" />
                                </div>

                                <div class="item-section">
                                    <span>Minimum Stock</span><br />
                                    <input type="number" name="miniumStock" id="miniumStock" min="1"
                                        pattern="\d+" required="required" class="form-control" />
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" id="add_inventory_new"
                                    class="btn btn-warning save-btn ml">Add</button> <button type="button"
                                    data-dismiss="modal"
                                    class="btn btn-default close-btn mr-auto data-reset-btn">Close</button>
                            </div>
