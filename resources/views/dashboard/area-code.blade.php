<x-layouts.dashboard-content>
    <div class="dashboard__content__box">
        <div class="form-group row">
            <div class="col-md-3">
                <form action="https://sdmstaging.5bb.com.mm/dashboard/area-code-search" method="get" class="search">
                    <input id="q" name="q" type="search" placeholder="Search .." aria-label="Search"
                        value="" class="form-control mr-sm-2">
                </form>
            </div>
            <div class="excel-btn col-md-6 ml-auto"><a href="https://sdmstaging.5bb.com.mm/dashboard/area-code/create"
