        ...
        <div class="row">
            <div class="col-md-3">
                <form action="https://sdmstaging.5bb.com.mm/dashboard/plan-search" method="get" class="search">
                    <input id="q" name="q" type="search" placeholder="Search .." aria-label="Search"
            ...
            <table id="sorting-table" class="plan-tb table table-hover mb-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/1/edit" class="plan-edit-btn">Edit</a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/6/edit" class="plan-edit-btn">Edit</a>
                        </td>
                        <td><button onclick="alert(`Can't delete this request. Related transactions exist.`)"
                                class="plan-dlt-btn">Delete</button></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/2/edit" class="plan-edit-btn">Edit</a>
                        </td>
                        <td><button onclick="alert(`Can't delete this request. Related transactions exist.`)"
                                class="plan-dlt-btn">Delete</button></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/3/edit" class="plan-edit-btn">Edit</a>
                        </td>
                        <td><button onclick="alert(`Can't delete this request. Related transactions exist.`)"
                                class="plan-dlt-btn">Delete</button></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/4/edit" class="plan-edit-btn">Edit</a>
                        </td>
                        <td><button onclick="alert(`Can't delete this request. Related transactions exist.`)"
                                class="plan-dlt-btn">Delete</button></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/5/edit" class="plan-edit-btn">Edit</a>
                        </td>
                        <td><button onclick="alert(`Can't delete this request. Related transactions exist.`)"
                                class="plan-dlt-btn">Delete</button></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/7/edit" class="plan-edit-btn">Edit</a>
                        </td>
                        <td><button onclick="alert(`Can't delete this request. Related transactions exist.`)"
                                class="plan-dlt-btn">Delete</button></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/8/edit" class="plan-edit-btn">Edit</a>
                        </td>
                        <td><button onclick="alert(`Can't delete this request. Related transactions exist.`)"
                                class="plan-dlt-btn">Delete</button></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="https://sdmstaging.5bb.com.mm/dashboard/plan/9/edit" class="plan-edit-btn">Edit</a>
                        </td>
                        <td><button onclick="alert(`Can't delete this request. Related transactions exist.`)"
                                class="plan-dlt-btn">Delete</button></td>
                    </tr>
