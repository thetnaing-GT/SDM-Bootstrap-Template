<aside id="scrollSidebar" class="dashboard__sidebar">
    ...
    <div class="dashboard__sidebar__items">
        <a @class(['active' => request()->routeIs('newDashboard')]) href="{{ route('newDashboard') }}">
            <span>
        ...
        <a @class(['active' => request()->routeIs('installation')]) href="{{ route('installation') }}">
            <span>
        ...
        <a @class(['active' => request()->routeIs('oncall')]) href="{{ route('oncall') }}">
            <span>
        ...
        <a @class(['active' => request()->routeIs('customer')]) href="{{ route('customer') }}">
            <span>
        ...
        <a @class(['active' => request()->routeIs('lsp')]) href="{{ route('lsp') }}">
            <span>
        ...
        <a @class(['active' => request()->routeIs('inventory')]) href="{{ route('inventory') }}">
            <span>
        ...
        <a @class(['active' => request()->routeIs('plan')]) href="{{ route('plan') }}">
            <span>
        ...
        <a @class(['active' => request()->routeIs('areacode')]) href="{{ route('areacode') }}">
            <span>
