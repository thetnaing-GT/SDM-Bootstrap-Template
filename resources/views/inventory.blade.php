                            ...
                            <tbody id="product-list">
                                <tr>
                                    ...
                                    <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                            data-toggle="modal" data-target="#exampleModal2" id="addRestock0">Restock</a>
                                    </td>
                                    <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                            data-toggle="modal" data-target="#exampleModal3" id="addReduce0">Reduce
                                            Stock</a></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                            data-toggle="modal" data-target="#exampleModal2" id="addRestock1">Restock</a>
                                    </td>
                                    <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                            data-toggle="modal" data-target="#exampleModal3" id="addReduce1">Reduce
                                            Stock</a></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                            data-toggle="modal" data-target="#exampleModal2" id="addRestock2">Restock</a>
                                    </td>
                                    <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                            data-toggle="modal" data-target="#exampleModal3" id="addReduce2">Reduce
                                            Stock</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                            data-toggle="modal" data-target="#exampleModal2" id="addRestock3">Restock</a>
                                    </td>
                                    <td class="text-left"><a type="button" class="btn btn-outline-warning restock-btn"
                                            data-toggle="modal" data-target="#exampleModal3" id="addReduce3">Reduce
                                            Stock</a>
                                    </td>
                                </tr>
                            </tbody>
